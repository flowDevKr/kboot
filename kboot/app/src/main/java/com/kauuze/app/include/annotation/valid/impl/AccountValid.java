...
import com.kauuze.app.include.annotation.valid.Account;
 ...
 */
public class AccountValid implements ConstraintValidator<Account,Object> {
    ...
    public boolean isValid(Object o, ConstraintValidatorContext constraintValidatorContext) {
        try {
            ...
            if(RU.isAccount(String.valueOf(o))){
                return true;
            }else{
                return false;
            }
